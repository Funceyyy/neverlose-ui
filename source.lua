...
function Library:Window(options)
    ...
    function tabsections:TabSection(options)
        ...
        tabSectionLabel.Font = Enum.Font.SourceSansBold
        ...
        function tabs:Tab(options)
            ...
            function sections:Section(options)
                ...
                sLine.Font = Enum.Font.SourceSansBold
                sLine.Text = ""
                ...
                function elements:Slider(options)
                    ...
                    sliderTextBox.Font = Enum.Font.SourceSansBold
                ...
                function elements:Colorpicker(options)
                    ...
                    colorpickerLabel.Font = Enum.Font.SourceSansBold
                    ...
                    Copy.MouseButton1Click:Connect(function()
                        if setclipboard then
                            ...
                            Notify("NEVERLOSE:", tostring(colorHex.Text))
                            Notify("NEVERLOSE:", "Done!")
                        else
                            print(tostring(colorHex.Text))
                            Notify("NEVERLOSE:", tostring(colorHex.Text))
                            Notify("NEVERLOSE:", "Your exploit does not support the function 'setclipboard', so we've printed it out.")
                        end
                    end)
